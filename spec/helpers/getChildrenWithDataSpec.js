...
describe('Baz.h.getChildrenWithData', function() {
  ...
  it('should prefix data attribute key', function () {
    ...
    expect(getChildrenWithData(node, 'data-camel-case')[0]).toEqual(childWithData)
  ...
  it('should get child with data key and value', function () {
    ...
    expect(getChildrenWithData(node, 'camelCase', 'value')[0]).toEqual(childWithData)
  })
  ...
  it('should not get child with data key and different value', function () {
    ...
    expect(getChildrenWithData(node, 'camelCase', 'value')[0]).toEqual(childWithCorrectValue)
  })
