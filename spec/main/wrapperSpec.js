...
describe('BazookaWrapper', function() {
  ...
  it('should return bound components', function() {
    ...
    expect(nodeComponents.exampleBazFunc.bazFunc).toBe(
      componentsRegistry.exampleBazFunc
    );

    expect(nodeComponents.exampleComplexBazComponent).toBe(
      componentsRegistry.exampleComplexBazComponent
    );

    expect(nodeComponents.exampleComplexBazFunclessComponent).toBe(
      componentsRegistry.exampleComplexBazFunclessComponent
    );
  });
});
